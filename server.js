...
const url = 'mongodb+srv://RickLeinecker:COP4331Rocks@cluster0.ehunp00.mongodb.net/COP4331?retryWrites=true&w=majority';
...
app.post('/api/login', async (req, res, next) =>
{
    ...
    // does not correctly link to. So you need to add db name to the client.
